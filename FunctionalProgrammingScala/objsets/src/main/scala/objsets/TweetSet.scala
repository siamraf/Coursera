...
abstract class TweetSet {
  ...
  def mostRetweetedHelp: Option[Tweet]
...
class Empty extends TweetSet {
  ...
  def mostRetweetedHelp: Option[Tweet] = None
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweetedHelp: Option[Tweet] = {
    val leftRec = left.mostRetweetedHelp
    val rightRec = right.mostRetweetedHelp
    val conc = elem :: (leftRec.toList ++ rightRec.toList)
    Some(conc.maxBy( t => t.retweets))
  }
